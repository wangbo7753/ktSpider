 ...
 */
public class KTDownLoader extends HttpClientDownloader {
    ...
    public KTDownLoader(DBLink dbLink, String devType) {
        this.dbLink = dbLink;
        this.devType = devType;
    }

    public KTDownLoader(DBLink dbLink, String devType, String exclude) {
        this.dbLink = dbLink;
        this.devType = devType;
